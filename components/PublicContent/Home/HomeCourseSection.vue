<template>
    ...
    <div class="container">
      ...
      <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-[30px] pt-10">
        ...
        <a class=" bg-white dark:bg-black shadow-box2 rounded-[8px] transition duration-100 hover:shadow-sm" href="#">
          ...
          <div class="course-content p-8">
            ...
            <h4 class=" text-xl mb-3 font-bold dark:text-white">Basic Fundamentals of Interior &amp; Graphics Design</h4>
        ...
        <a class=" bg-white dark:bg-black shadow-box2 rounded-[8px] transition duration-100 hover:shadow-sm" href="#">
          ...
          <div class="course-content p-8">
            ...
            <h4 class=" text-xl mb-3 font-bold dark:text-white">Increasing Engagement with Instagram &amp; Facebook</h4>
            <div class="flex justify-between  space-x-3">
              <span class=" flex items-center space-x-2">
                        <img src="@/assets/images/svg/file.svg" alt="">
                            <span>2 Lessons</span>
        ...
        <a class=" bg-white dark:bg-black shadow-box2 rounded-[8px] transition duration-100 hover:shadow-sm" href="#">
          ...
          <div class="course-content p-8">
            ...
            <h4 class=" text-xl mb-3 font-bold dark:text-white">Introduction to Color Theory &amp;
              Basic UI/UX</h4>
            <div class="flex justify-between  space-x-3">
              <span class=" flex items-center space-x-2">
                        <img src="@/assets/images/svg/file.svg" alt="">
        ...
        <a class=" bg-white dark:bg-black shadow-box2 rounded-[8px] transition duration-100 hover:shadow-sm" href="#">
          ...
          <div class="course-content p-8">
            <div class="text-secondary font-bold text-2xl mb-3">$72.39</div>
            <h4 class=" text-xl mb-3 font-bold dark:text-white">Financial Security Thinking and Principles Theory</h4>
            <div class="flex justify-between  space-x-3">
              <span class=" flex items-center space-x-2">
                        <img src="@/assets/images/svg/file.svg" alt="">
                            <span>2 Lessons</span>
        ...
        <a class=" bg-white dark:bg-black shadow-box2 rounded-[8px] transition duration-100 hover:shadow-sm" href="#">
          ...
          <div class="course-content p-8">
            <div class="text-secondary font-bold text-2xl mb-3">Free</div>
            <h4 class=" text-xl mb-3 font-bold dark:text-white">Logo Design: From Concept to Presentation</h4>
            <div class="flex justify-between  space-x-3">
              <span class=" flex items-center space-x-2">
                        <img src="@/assets/images/svg/file.svg" alt="">
                            <span>2 Lessons</span>
        ...
        <a class=" bg-white dark:bg-black shadow-box2 rounded-[8px] transition duration-100 hover:shadow-sm" href="#">
          ...
          <div class="course-content p-8">
            ...
            <h4 class=" text-xl mb-3 font-bold dark:text-white">Professional Ceramic Moulding for Beginners</h4>
            <div class="flex justify-between  space-x-3">
              <span class=" flex items-center space-x-2">
                        <img src="@/assets/images/svg/file.svg" alt="">
                            <span>2 Lessons</span>
