<template>
    ...
    <div class="container">
      ...
      <div class="grid  xl:grid-cols-2 grid-cols-1 gap-[30px] lg:pt-10 pt-5">
        ...
        <a class=" bg-white rounded-[8px] transition duration-150 border-b-4 hover:border-primary border-transparent
            hover:shadow-box6 sm:flex p-8 sm:space-x-6 space-y-6 sm:space-y-0" href="#">
          <div class="flex-none">
            <div class="sm:w-[159px] h-[159px]  rounded  relative">
