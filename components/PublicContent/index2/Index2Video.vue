    ...
    <div class=" relative video-area section-padding-bottom z-[0]">
        ...
        <div class="container ">
            <div class="video-wrapper xl:mb-[205px] lg:mb-[150px] mb-20">
                <div
                    class="xl:h-[652px] lg:h-[500px] h-[400px] max-w-[1112px]  mx-auto p-6 bg-white shadow-box8 rounded-lg relative ">
                    ...
                    <div class="h-[80px] w-[80px] mx-auto absolute left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 flex flex-col justify-center
                        items-center">
                        <div class="animate-ping absolute inline-flex h-full w-full rounded-full ring-white ring-2">
                        </div>
                        <a href="#"
                            class="bg-white w-20 h-20 flex flex-col justify-center items-center rounded-full text-3xl text-primary  ">
