<template>
    <div
        class="feature-area bg-[url('../images/all-img/section-bg-6.png')] bg-cover bg-no-repeat bg-center section-padding">
        <div class="container">
            <div class="text-center">
                <div class="mini-title">Course Categories</div>
                <div class="column-title ">
                    Browse Top
                    <span class="shape-bg">Categories</span>
                </div>
            </div>
