...
<footer>
    <div class="relative z-[0] mx-auto max-w-[1170px] rounded-md bg-[url('../images/all-img/section-bg-3.png')] bg-cover bg-center bg-no-repeat p-20">
    ...
    <div class="-mt-[150px] bg-[url('../images/all-img/section-bg-10.png')] bg-cover bg-center bg-no-repeat pt-[150px]">
      <div class="section-padding container">
        <div class="grid grid-cols-12 gap-5">
            ...
            <div class="ml-auto xl:w-[80%]">
              <div class="flex space-x-[80px]">
                <div class="flex-1 lg:flex-none">
                  <h4 class="mb-8 text-2xl font-bold text-black dark:text-black">Links</h4>
                ...
                <div class="flex-1 lg:flex-none">
                  <h4 class="mb-8 text-2xl font-bold text-black dark:text-black">Legal</h4>
                  <ul class="list-item space-y-5">
          ...
          <div class="single-footer col-span-12 lg:col-span-6 xl:col-span-3">
            <h4 class="mb-8 text-2xl font-bold text-black dark:text-black">Instagram Post</h4>
      ...
      <div class="container border-t border-[#E9D4D0] py-8 text-center text-base">
        © Copyright 2022 | Edumim Template | All Rights
        Reserved
      </div>
    </div>
  </footer>
