<template>
    <div class=" bg-white shadow-box12 rounded-[8px] transition duration-100 hover:shadow-box13 dark:text-black">
              ...
              <div class="course-content p-8">
                <div class="flex   lg:space-x-10 space-x-5 mb-5">
                  <NuxtLink class=" flex items-center space-x-2" to="blog-single">
                ...
                <h4 class=" text-xl mb-5 font-bold dark:text-black">
                  <NuxtLink to="blog-single" class=" hover:text-primary transition duration-150">
                    Professional Mobile Painting and Sculpting
                  </NuxtLink>
                </h4>
                <NuxtLink to="blog-single" class=" text-black font-semibold hover:underline transition duration-150">Read More</NuxtLink>
              </div>
            </div>
</template>