    ...
    <div class="lg:col-span-4 col-span-12 dark:text-black">
        <div class="sidebarWrapper space-y-[30px]">
            ...
            <div class="wdiget widget_catagory">
                <h4 class="widget-title dark:text-black">Categories</h4>
            ...
            <div class="wdiget widget-recent-post">
                <h4 class=" widget-title dark:text-black">Related Courses</h4>
                <ul class="list">
            ...
            <div class="wdiget">
                <h4 class="widget-title dark:text-black">Popular Tags</h4>
            ...
            <div class="wdiget">
                <h4 class="widget-title dark:text-black">Instagram Feed</h4>
